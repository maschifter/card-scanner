...
public:
   ...
   * @param classNames Map of class ID to game name (required)
   ...
   * @throws std::runtime_error if model loading fails or classNames is empty
   */
...
private:
  ...
  std::map<int, std::string> classNames_; ///< Class ID to game name mapping
