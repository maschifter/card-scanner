...
public:
   ...
   * @param cardMatches Recognition results (to check game)
...
private:
   ...
   */
  static bool hasSetSymbolModels(cardscanner::SetSymbolYoloModel *yoloModel,
                                 cardscanner::SetSymbolEmbedder *embedder,
