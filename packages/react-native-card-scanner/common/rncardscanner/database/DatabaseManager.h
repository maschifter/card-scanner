...
public:
  ...
  /**
   * @brief Gets a metadata value from a specific game's database
   * @param gameName Name of the game (e.g., "mtg", "pokemon")
   * @param key The metadata key to look up
   * @return The metadata value as a string, or an empty string if not found.
   */
  std::string getMetadataValue(const std::string &gameName,
